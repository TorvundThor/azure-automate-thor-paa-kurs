...
if ($(summerKort -kortstokk $meg) -gt $(summerKort -kortstokk $magnus))
    { Write-Output "vinner: meg"}
elseif ($(summerKort -kortstokk $meg) -lt $(summerKort -kortstokk $magnus)) 
    { Write-Output "vinner: Magnus"}
else 
    { Write-Output "Draw"}

Write-output "meg | $(summerKort -kortstokk $meg) | $(listKort -stokk $meg)"
Write-output "meg | $(summerKort -kortstokk $magnus) | $(listKort -stokk $magnus)"
